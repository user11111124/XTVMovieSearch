# Don't Remove Credit @lalisaKdrama
...
BATCH_FILES = {}
MOVIE_REQUESTS = {}  # Stores {user_id: movie_name}
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgUAAxkBAAIFHWfNoyXcy4NaIGrCil6RqOyIe4ZTAAIEHAACpONpVofZ2n_hDNikHgQ") 
    ...
    if data.split("-", 1)[0] == "BATCH":
        if not await db.has_premium_access(message.from_user.id):
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                btn = [[
                    ...
                    InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ - ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪꜰʏ", callback_data="buy_premium")
                ]]
                text = "<b>ʜᴇʏ {} 👋,\n\nʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ, ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ ᴠᴇʀɪғʏ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛᴏᴅᴀʏ.</b>"
                if PREMIUM_AND_REFERAL_MODE == True:
                    text += "\n<b><blockquote>ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴅɪʀᴇᴄᴛ ғɪʟᴇꜱ ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴꜱ ᴛʜᴇɴ ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ☺️</blockquote>\n\n💶 ꜱᴇɴᴅ /plan ᴛᴏ ʙᴜʏ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ</b>"
        ...
        for msg in msgs:
            ...
            await asyncio.sleep(1) 
        await sts.delete()
        k = await client.send_message(chat_id = message.from_user.id, text=f"<blockquote><b>‼️ ᴛʜɪꜱ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 5 ᴍɪɴᴜᴛᴇꜱ . ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴀʟʟ ᴄᴏɴᴛᴇɴᴛ ᴛᴏ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ✅</b></blockquote>")
        await asyncio.sleep(300)
        for x in filesarr:
            await x.delete()
        await k.edit_text("<b>✅ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ ʜᴀꜱ ʙᴇᴇɴ sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ</b>")  
        return
        ...
        if is_valid == True:
            ...
            log_text= f"<b>☄ ᴛᴏᴋᴇɴ ᴠᴇʀɪꜰɪᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ☄\n#completed_token_verification\n\n⚡️ ɴᴀᴍᴇ:- {message.from_user.mention}\n⚡️ ID <code>{userid}</code>\n\n 📆 ᴅᴀᴛᴇ:- <code>{datetime.datetime.now(pytz.timezone('Asia/Kolkata')).strftime('%d %B %Y')} </code></b>"
            await client.send_message(chat_id=PREMIUM_LOGS, text=log_text)
        else:
            return await message.reply_text(text="<b>ɪɴᴠᴀʟɪᴅ ʟɪɴᴋ ᴏʀ ᴇxᴘɪʀᴇᴅ ʟɪɴᴋ</b>", protect_content=True)
    ...
    if data.startswith("sendfiles"):
        ...
        await asyncio.sleep(300)
        await k.edit("<b>✅ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ ʜᴀꜱ ʙᴇᴇɴ sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ</b>")
        return
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(text=f"<blockquote><b>‼️ ᴛʜɪꜱ ꜰɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ɪɴ 5 ᴍɪɴᴜᴛᴇꜱ . ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴀʟʟ ᴄᴏɴᴛᴇɴᴛ ᴛᴏ ʏᴏᴜʀ ꜱᴀᴠᴇᴅ ᴍᴇꜱꜱᴀɢᴇ ✅</b></blockquote>")
            await asyncio.sleep(300)
            await msg.delete()
            await k.edit_text("<b>✅ ʏᴏᴜʀ ꜰɪʟᴇ ʜᴀꜱ ʙᴇᴇɴ sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ.\nɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴀɢᴀɪɴ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ</b>",reply_markup=InlineKeyboardMarkup(btn))
            return
        except:
            pass
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        await msg.edit('ꜰɪʟᴇ ʜᴀꜱ ʙᴇᴇɴ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ꜰʀᴏᴍ ᴅᴀᴛᴀʙᴀꜱᴇ')
    else:
...
# @Client.on_message((filters.command(["request", "Request", "req", "Req"]) | filters.regex("#request") | filters.regex("#Request") | filters.regex("#req") | filters.regex("#Req")) & filters.group)
@Client.on_message(
    (
        filters.command(["request", "Request", "req", "Req"]) | 
        filters.regex(r"#request") | 
        filters.regex(r"#Request") | 
        filters.regex(r"#req") | 
        filters.regex(r"#Req")
    ) & filters.group
...
async def requests(bot, message):
    ...
    if message.reply_to_message:
        ...
        # ✅ Store the requested movie
        if len(content) >= 3:
            MOVIE_REQUESTS[reporter] = content  # Store request
            
        try:
            if REQST_CHANNEL is not None:
                btn = [[
                    InlineKeyboardButton('ᴠɪᴇᴡ ʀᴇQᴜᴇꜱᴛ', url=f"{message.reply_to_message.link}"),
                ...
                if len(content) < 3:
                    await message.reply_text("<b>ʏᴏᴜ ᴍᴜꜱᴛ ᴛʏᴘᴇ ᴀʙᴏᴜᴛ ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ [ᴍɪɴɪᴍᴜᴍ 3 ᴄʜᴀʀᴀᴄᴛᴇʀꜱ]. ʀᴇQᴜᴇꜱᴛꜱ ᴄᴀɴ'ᴛ ʙᴇ ᴇᴍᴘᴛʏ.</b>")
            if len(content) < 3:
                success = False
        except Exception as e:
        ...
        chat_id = message.chat.id
        group_name = message.chat.title if message.chat.title else "ᴜɴᴋɴᴏᴡɴ ɢʀᴏᴜᴘ"
        reporter = str(message.from_user.id)
        mention = message.from_user.mention
        success = True
        ...
        # ✅ Store the requested movie
        if len(content) >= 3:
            MOVIE_REQUESTS[reporter] = content

        try:
            if REQST_CHANNEL is not None and len(content) >= 3:
                btn = [[
                    InlineKeyboardButton('ᴠɪᴇᴡ ʀᴇQᴜᴇꜱᴛ', url=f"{message.link}"),
                    InlineKeyboardButton('ꜱʜᴏᴡ ᴏᴘᴛɪᴏɴꜱ', callback_data=f'show_option#{reporter}')
                ]]
                #reported_post = await bot.send_message(chat_id=REQST_CHANNEL, text=f"<b>𝖱𝖾𝗉𝗈𝗋𝗍𝖾𝗋 : {mention} ({reporter})\n\n𝖬𝖾𝗌𝗌𝖺𝗀𝖾 : {content}</b>", reply_markup=InlineKeyboardMarkup(btn))
                reported_post = await bot.send_message(
                    chat_id=REQST_CHANNEL,
                    text=f"ʀᴇQᴜᴇꜱᴛ ꜰʀᴏᴍ : {group_name}\n\n"
                    f"<b><blockquote>⚡️ᴄᴏɴᴛᴇɴᴛ : {content}\n"
                    f"🌟ʀᴇQᴜᴇꜱᴛᴇᴅ ʙʏ : {mention} ({reporter})</blockquote></b>",
                    reply_markup=InlineKeyboardMarkup(btn)
                )
                success = True
            elif len(content) >= 3:
    ...
    if success:
        ...
        btn = [[
            ...
            InlineKeyboardButton('ᴠɪᴇᴡ ʀᴇQᴜᴇꜱᴛ', url=f"{reported_post.link}")
        ]]
        await message.reply_text("<b>ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛ ʜᴀꜱ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ! ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ ꜰᴏʀ ꜱᴏᴍᴇ ᴛɪᴍᴇ.\n\n<blockquote>ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ꜰɪʀꜱᴛ & ᴠɪᴇᴡ ʀᴇQᴜᴇꜱᴛ</blockquote></b>", reply_markup=InlineKeyboardMarkup(btn))
    ...
    if message.reply_to_message:
        ...
        try:
            ...
            if str(user.id) in str(out):
                ...
                success = False
            if success:
                await message.reply_text(f"<b>ʏᴏᴜʀ ᴍᴇꜱꜱᴀɢᴇ ʜᴀꜱ ʙᴇᴇɴ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ꜱᴇɴᴅ ᴛᴏ {user.mention}.</b>")
            else:
    ...
    if len(message.command) == 2:
      ...
      #  time = message.command[2]
        ...
        if seconds > 0:
            ...
            await client.send_message(
                chat_id=user_id,
                text="<b>ᴘʀᴇᴍɪᴜᴍ ʀᴇᴍᴏᴠᴇᴅ ʙʏ ᴀᴅᴍɪɴꜱ \n\n ᴄᴏɴᴛᴀᴄᴛ ᴀᴅᴍɪɴ ɪꜰ ᴛʜɪꜱ ɪꜱ ᴍɪꜱᴛᴀᴋᴇ \n\n 👮 ᴀᴅᴍɪɴ : {} \n</b>".format(OWNER_LNK),                
            )
        else:
...
async def plans_cmd_handler(client, message): 
    user_id = message.from_user.id
    users = message.from_user.mention(style="html")
    log_message = f"<b>🔥 ᴛʜɪꜱ ᴜꜱᴇʀ ᴛʀɪᴇᴅ ᴛᴏ ᴄʜᴇᴄᴋ ᴘʟᴀɴ\n\n<blockquote>• ᴜꜱᴇʀ ɪᴅ - `{user_id}`</blockquote>\n<blockquote>• ɴᴀᴍᴇ - {users}</blockquote></b>"
    if PREMIUM_AND_REFERAL_MODE == False:
        return 
    btn = [            
...
async def check_plans_cmd(client, message):
    ...
    if await db.has_premium_access(user_id):
        ...
        reply_markup = InlineKeyboardMarkup(btn)
        m=await message.reply_sticker("CAACAgUAAxkBAAIFHWfNoyXcy4NaIGrCil6RqOyIe4ZTAAIEHAACpONpVofZ2n_hDNikHgQ")         
        await message.reply_text(f"**😢 ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀɴʏ ᴘʀᴇᴍɪᴜᴍ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ.\n\n ᴄʜᴇᴄᴋ ᴏᴜᴛ ᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ /plan**",reply_markup=reply_markup)
        await asyncio.sleep(1)
        await m.delete()
