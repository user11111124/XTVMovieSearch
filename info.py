...
# Bot information
SESSION = environ.get('SESSION', '𝕏𝕋𝕍')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002516448114 -1002573906766 -1002455551310').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002382271598')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Channel Is For Index Request 
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002382271598'))
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://germanmoviesfy:HwQ5lKpqCzC71td4@cluster0.zdheq6j.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://XTVLOVER:6xTYd8r2a3fCFPEH@cluster0.ao9b0hf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://xtveurope:b7Lg1bp2h3GTgZuh@cluster0.j9khh9q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b><blockquote>‣ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs</blockquote>\n\n• 1 ᴡᴇᴇᴋ - 15ʀs\n• 1 ᴍᴏɴᴛʜ - 40ʀs\n• 3 ᴍᴏɴᴛʜ - 100ʀs\n\n<blockquote>‣ ᴜᴘɪ ɪᴅ - <code>sasuke-35@ibl</code></blockquote>\n\n<blockquote>‣ ᴘʀᴇᴍɪᴜᴍ ғᴇᴀᴛᴜʀᴇs</blockquote>\n\n• ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪғʏ\n• ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ\n• ᴀᴅ-ғʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ\n• ᴅɪʀᴇᴄᴛ ꜰɪʟᴇꜱ\n• ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs, ᴅʀᴀᴍᴀꜱ & sᴇʀɪᴇs\n\n<blockquote>‣ ʙᴜʏ ᴘᴀɪᴅ ᴘʟᴀɴ ʙʏ - /plan\n‣ ᴄʟɪᴄᴋ ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ /myplan</blockquote>\n<blockquote>💢 ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ ʜᴇʀᴇ <a href="https://t.me/inocent_aman">ꜱᴀꜱᴜᴋᴇ</a></blockquote></b>')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/XTVchat/17') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/XTV_official')
SUPPORT_CHAT_ID = environ.get('SUPPORT_CHAT_ID', '-1002534169129')
...
MSG_ALRT = environ.get('MSG_ALRT', 'ʏᴏ! ʟᴏɴɢ  ᴛɪᴍᴇ ɴᴏ ꜱᴇᴇ')
